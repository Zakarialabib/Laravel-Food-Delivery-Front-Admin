            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{route('admin.campaign.add-new', 'basic')}}">
                        <i class="tio-add-circle"></i> {{__('Add new campaign')}}
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    <div class="card-header p-1">
                        <h5>{{__('Campaign list')}}<span class="badge badge-soft-dark ml-2" id="itemCount">{{$campaigns->total()}}</span></h5>
                        <form id="search-form">
                            @csrf
                            <!-- Search -->
                            <div class="input-group input-group-merge input-group-flush">
                                ...
                                <input id="datatableSearch" type="search" name="search" class="form-control" placeholder="{{__('Search here')}}" aria-label="Search here">
