    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{route('admin.category.add')}}">{{trans('messages.categories')}}</a>
                </li>
                <li class="breadcrumb-item text-capitalize">{{trans('messages.bulk_import')}} </li>
            </ol>
        </nav>
        ...
        <div class="card mt-2 rest-part">
            <div class="card-header">
                <h4>{{__('messages.export')}} {{__('messages.categories')}}</h4>
            </div>
            <div class="card-body">
