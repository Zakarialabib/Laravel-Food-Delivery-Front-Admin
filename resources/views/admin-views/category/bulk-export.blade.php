...
@section('title',__('Category Bulk Export'))
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="{{route('admin.category.add')}}">{{__('categories')}}</a>
                </li>
                <li class="breadcrumb-item text-capitalize">{{__('Bulk import')}} </li>
            </ol>
        </nav>
