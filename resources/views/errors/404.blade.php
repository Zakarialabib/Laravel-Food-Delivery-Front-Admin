...
<head>
    ...
    <!-- Title -->
    <title>{{__('error')}} 404 | {{\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Stack TIKTAK'}}</title>
...
<div class="footer text-center">
    <ul class="list-inline list-separator">
        <li class="list-inline-item">
            <a class="list-separator-link" target="_blank" href="{{route('contact-us')}}">{{\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Stack TIKTAK'}} {{__('support')}}</a>
        </li>
    </ul>
</div>
<!-- End Footer -->
