                                                                    ...
                                                                    <div class="pricing">
                                                                        ...
                                                                        <div class="add-remove-button">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input
                                                                                    wire:click="removeFromCartNav({{ $details['id'] }})"
                                                                                    type="button" value="-"
                                                                                ...
                                                                                <input
                                                                                    wire:click="addToCartNav({{ $details['id'] }})"
                                                                                    type="button" value="+"
                                                                                    class="button-plus changeQuantity"
                                                                                    id="changeQuantity"
                                                                                    data-field="quantity" />
                                                                            </div>
                                                                        </div>
...
<section class="py-60 min-window-height">
    <div class="container">
        ...
        <div class="empty-orders-div" style="align:center">
            ...
            <a href="{{ route('restaurant_listing') }}" class="btn btn-primary mt-3">See Restaurants Near
                You</a>
        </div>
