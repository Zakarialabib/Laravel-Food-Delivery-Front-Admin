                        ...
                        <div class="order-status">
                            <div class="order-tracking-status-head">
                                ...
                                @if ($order->order_type == 'delivery')
                                    <p class="mb-0">Thanks for shopping! Your order number
                                        is<strong>#{{ $order->id }}</strong>. The restaurant will deliver your order by
