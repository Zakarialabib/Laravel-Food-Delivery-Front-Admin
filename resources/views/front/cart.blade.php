        ...
        <div class="table-responsive-lg">
            <table class="cart-table table mb-0 pb-0">
                                ...
                                <td class="product-item">
                                    <div class="dish-image">
                                        @if (empty($details['image']))
                                            <img class="aspect-video w-96 rounded-t-2xl object-cover object-center" src="{{ asset('storage/app/public/product/' . $product['image'] )}}">
                                        @else
                                ...
                                <td>
                                    <div class="add-remove-button">
                                        <div class="input-group">
                                            ...
                                            <a onclick="updateQty('{{ $id }}', 'plus')" class="number-button  plus">+</a>
                                        </div>
                                    </div>
                                </td>
                                <td>{{ $total }}</td>
                                <td>
                                    <a href="#" onclick="removeFromCart(this, '{{ $id }}')" class="float-right"><i
                ...
                <tfoot>
                    <tr>
                        <td class="product-item">
                            <a href="{{ route('checkout') }}" class="btn btn-primary float-right check-out-btn">Proceed to checkout</a>
                        </td>
                        <td colspan="2">Order Total</td>
                        <td colspan="2"><b>{{ $ttotal }} $</b></td>
                    </tr>
                </tfoot>
            </table>
        </div>
