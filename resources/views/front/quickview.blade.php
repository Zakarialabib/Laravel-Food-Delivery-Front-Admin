...
<div class="modal-body">
    <div class="d-flex flex-row">
        ...
        <span class="badge badge-{{$product->veg?'success':'danger'}} position-absolute">{{$product->veg?__('veg'):__('non_veg')}}</span>
        @endif
        <!-- Product gallery-->
        ...
        <div class="details pl-2">
            <a  class="h3 mb-2 product-title text-capitalize text-break">{{$product->name}}</a>
